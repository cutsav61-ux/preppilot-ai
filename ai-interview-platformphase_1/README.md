...
**Phase 1 — Authentication.** Registration, login, JWT access + rotating refresh tokens, logout, forgot/reset password, protected routes, and profile management are all live end-to-end (client + server). Dashboard home, interview generator, and analytics land in later phases.
